...
export interface Provider {
  ...
  experienceLevel?: 'Entry Level' | 'Intermediate' | 'Senior / Expert' | string;
  yearsExperience?: number;
  serviceMode?: 'Remote / Online' | 'On-site / In-person' | 'Hybrid' | string;
  specialties?: string[];
  skills?: string[];
  languages?: string[];
  ...
  // Verifications & Badges (Admin Overrides)
